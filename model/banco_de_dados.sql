...
-- ------------------------------------------------------------
-- Tabela: usuarios
-- Armazena moradores e agentes da Defesa Civil
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Tabela: ocorrencias
-- Registro central de todas as ocorrências do sistema
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- Dados iniciais para teste (opcional — remova em produção)
-- Senha padrão de todos: "senha123" (hash bcrypt gerado externamente)
-- ------------------------------------------------------------
